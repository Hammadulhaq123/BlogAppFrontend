                ...
                <div className="container mx-auto my-4 px-4 lg:px-20">
                    ...
                    <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 bg-gray-100 dark:bg-[#0e0e10] mr-auto rounded-2xl shadow-2xl">
                        ...
                        <form>
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                                <input className="w-full bg-white dark:bg-[#1c1c1c] dark:text-white text-[#1c1c1c] mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" onChange={handleChange}
                            ...
                            <div className="grid grid-cols-1 gap-5 mt-5">
                                <input className="w-full bg-white dark:bg-[#1c1c1c] dark:text-white text-[#1c1c1c] mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" onChange={handleChange}
                                    name="user_name" type="text" placeholder="Username" required />
                            </div>
                            <div className="grid grid-cols-1 gap-5 mt-5">
                                <input className="w-full bg-white dark:bg-[#1c1c1c] dark:text-white text-[#1c1c1c] mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" onChange={handleChange}
                            ...
                            <div className="my-5 w-1/2 lg:w-1/4">
                                <button onClick={handleSubmit} className="uppercase text-sm font-bold tracking-wide bg-gradient text-gray-100 p-3 rounded-lg w-full 
                    ...
                    <div
                        ...
                        <div className="flex flex-col text-white ">
                            <h1 className="font-bold uppercase text-4xl  my-4">Sign up & be a user!</h1>
